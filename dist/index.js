...
const center_route_1 = __importDefault(require("./routes/center.route"));
...
app.use(auth_provider_1.default.registerPassportPolicies());
console.log('===================== Starting Server =====================');
app.use(auth_route_1.default);
app.use(user_route_1.default);
app.use(center_route_1.default);
app.listen(port, () => {
